      ...
      <div className="container-custom">
        <div className="mx-auto max-w-4xl">
          ...
          <div className="mt-20 animate-fade-in">
            <div className="rounded-2xl bg-gradient-to-r from-primary-600 to-accent-600 p-8 text-center text-white md:p-12">
              ...
              <div className="grid grid-cols-2 gap-6 md:grid-cols-4">
                <div>
                  <div className="mb-2 text-3xl font-bold md:text-4xl">50+</div>
                ...
                <div>
                  <div className="mb-2 text-3xl font-bold md:text-4xl">⚡</div>
                  <div className="text-primary-100">Fast HMR</div>
                </div>
                <div>
                  <div className="mb-2 text-3xl font-bold md:text-4xl">✨</div>
                  <div className="text-primary-100">Modern</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="mt-20 animate-fade-in">
            ...
            <div className="overflow-x-auto rounded-lg bg-gray-900 p-6 text-left">
              ...
              <div className="font-mono text-sm text-green-400">
                <div className="mb-2">
                  ...
                  https://github.com/your-repo/react-template.git
                </div>
                <div className="mb-2">
